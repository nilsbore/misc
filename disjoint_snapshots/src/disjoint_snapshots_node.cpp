...
int main(int argc, char** argv)
{
    ...
    message_filters::Subscriber<sensor_msgs::Image> depth_sub(n, "/chest_xtion/depth/image_raw", 1);
    message_filters::Subscriber<sensor_msgs::Image> rgb_sub(n, "/chest_xtion/rgb/image_color", 1);
